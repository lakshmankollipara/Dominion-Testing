...
int initializeGame(int numPlayers, int kingdomCards[10], int randomSeed,
  ...
  state->numPlayers = numPlayers;			//having problems here ******************************************
...
int council_room_test(int currentPlayer, struct gameState *state, int handPos) {		//1st refactored Function
	int i = 0;
...
int village_test(int currentPlayer, struct gameState *state, int handPos) {		//2nd refactored Function
	drawCard(currentPlayer, state);
...
int steward_test(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2, int choice3) {
...
int remodel_test(int currentPlayer, struct gameState *state, int handPos, int choice1, int choice2) {
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
    ...
    case council_room:
     ...
     /* for (i = 0; i < 4; i++)
	{
	  drawCard(currentPlayer, state);				***************** REFACTORED *********************
	}
